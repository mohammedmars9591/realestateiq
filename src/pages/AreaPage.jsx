...
const AreaPage = () => {
  ...
  // 🟢 NEW: RENTAL & SALE ANALYSIS TEXTS
      ...
      <div ref={reportRef} className="bg-slate-50 p-1 md:p-4 rounded-3xl"> 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              {/* 🟢 NEW SECTION: RENTAL & SALES PRICES ANALYSIS */}
              ...
              <div className="bg-orange-50/50 p-4 rounded-xl border border-orange-100 text-xs text-slate-600 italic">
                 <strong>Tip:</strong> Investing in off-plan properties with flexible payment plans can offer significant capital appreciation potential in this district.
              </div>
